...
ThreadPool::ThreadPool() {
    ...
    if (iThreadCount == 0) {
        ...
        sgc::GcInfoCallbacks::getWarningCallback()("hardware concurrency information is not available");
    }
...
size_t ThreadPool::getThreadCount() const { return vRunningThreads.size(); }
